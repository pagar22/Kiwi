...
import com.example.aaryanpagar.drawer.Tests.TestsMain;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.HashSet;

public class Class0Assignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.class_ass_0);
        className= (TextView) findViewById(R.id.class_ass_0_name);
        fab= (FloatingActionButton) findViewById(R.id.class_ass_0_add);
        //INTENT
        final Intent intent= getIntent();
        classId= intent.getIntExtra("classId",-1);
        className.setText(ClassMain.classList.get(classId));
        //LIST IMPLEMENT
        listView= (ListView) findViewById(R.id.class_ass_0_list);
        arrayAdapter= new ArrayAdapter(Class0Assignment.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1= new Intent(Class0Assignment.this, SetAssignments.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(Class0Assignment.this)
                        .setTitle("ASSIGNMENT")
                        .setMessage(s)
