...
public class Class5Assignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.class_ass_5);
        className= (TextView) findViewById(R.id.class_ass_5_name);
        fab= (FloatingActionButton) findViewById(R.id.class_ass_5_add);
        Intent intent= getIntent();
        classId= intent.getIntExtra("classId",-1);
        className.setText(ClassMain.classList.get(classId));

        //ListView
        listView= (ListView) findViewById(R.id.class_ass_5_list);
        arrayAdapter= new ArrayAdapter(Class5Assignment.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1= new Intent(Class5Assignment.this, SetAssignments.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(Class5Assignment.this)
                        .setTitle("ASSIGNMENT")
                        .setMessage(s)
