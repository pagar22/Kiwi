...
public class Class2Assignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.class_ass_2);
        className= (TextView) findViewById(R.id.class_ass_2_name);
        fab= (FloatingActionButton) findViewById(R.id.class_ass_2_add);
        Intent intent= getIntent();
        classId= intent.getIntExtra("classId",-1);
        className.setText(ClassMain.classList.get(classId));

        //listview
        listView= (ListView) findViewById(R.id.class_ass_2_list);
        arrayAdapter= new ArrayAdapter(Class2Assignment.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1= new Intent(Class2Assignment.this, SetAssignments.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(Class2Assignment.this)
                        .setTitle("ASSIGNMENT")
                        .setMessage(s)
