...
public class Class1Assignment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.class_ass_1);
        className= (TextView) findViewById(R.id.class_ass_1_name);
        fab= (FloatingActionButton) findViewById(R.id.class_ass_1_add);
        final Intent intent= getIntent();
        classId= intent.getIntExtra("classId",-1);
        className.setText(ClassMain.classList.get(classId));

        //List view
        listView= (ListView) findViewById(R.id.class_ass_1_list);
        arrayAdapter= new ArrayAdapter(Class1Assignment.this,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1= new Intent(Class1Assignment.this, SetAssignments.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(Class1Assignment.this)
                        .setTitle("ASSIGNMENT")
                        .setMessage(s)
